...
public class TestFastDFS {
	...
	public void testUploadFile() throws Exception{
        ...
        //3.加载配置文件 
		ClientGlobal.init("F:/study/e3mall/e3mall/git/e3-manager-web/src/main/resources/resource/client.conf");
        ...
        String[] upload_files = storageClient.upload_file("F:/img/1.jpg", "jpg", metaList);  
